...
class TestDrone(unittest.TestCase):
    ...
    def test_drone_position_update(self):
        ...
        expected_position = initial_position + np.array([0.1, 0, 0])
...
class TestInterceptor(unittest.TestCase):
    ...
    def test_interceptor_initialization(self):
        ...
        self.assertEqual(self.interceptor.intercept_speed, 30.0)
    ...
    def test_interceptor_target_tracking(self):
        ...
        # Interceptor should have moved toward target
    ...
    def test_interceptor_stops_when_close(self):
        ...
        original_speed = self.interceptor.intercept_speed
        ...
        self.interceptor.intercept_speed = original_speed
...
class TestIntegration(unittest.TestCase):
    ...
    def test_basic_interception_scenario(self):
        """Test basic integration of drone, radar, and interceptor"""
        # Start systems
        self.drone.start_flying()
        self.interceptor.start_flying()
        ...
        self.assertEqual(len(self.drone.history), 6)  # Initial + 5 updates
